...
export async function getBookExamples(isbn: string) {
  return client()
    .get(`books/${isbn}/examples`)
    .json()
    .then(ExamplesSchema.parse);
}
...
export async function getBookExample(isbn: string, exampleId: string) {
  return client()
    .get(`books/${isbn}/examples/${exampleId}`)
    .json()
    .then(ExampleSchema.parse);
}

export async function addBookExample(isbn: string, data: CreateExampleInput) {
  return client()
    .post(`books/${isbn}/examples`, { json: data })
    .json()
    .then(ExampleSchema.parse);
}
...
export async function addTransaction(data: {
  ...
  return client()
    ...
    .json()
    .then(StoredTransactionSchema.parse);
}
...
export async function endTransaction(userId: string, transactionId: string) {
  return client()
    .post(`users/${userId}/transactions/${transactionId}/end`)
    .json()
    .then(StoredTransactionSchema.parse);
}
...
export async function getUserNotifications(userId: string) {
  return client()
    ...
    .json()
    .then(NotificationsSchema.parse);
}
